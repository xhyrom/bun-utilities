 ...
 */
export const execAndDontWait = nativeBinding.execAndDontWait;
/**
 * @type {import('./index').spawnAndDontWait}
 */
export const spawnAndDontWait = nativeBinding.spawnAndDontWait;
/**
 ...
 */
export const copyfile = nativeBinding.copyfile;
/**
